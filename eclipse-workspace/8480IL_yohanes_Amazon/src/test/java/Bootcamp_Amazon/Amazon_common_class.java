...
public class Amazon_common_class {
	...
	public void Browsers(String browser, String wbsite) throws InterruptedException {
		  ...
		  System.setProperty("webdriver.edge.driver", local+"\\mydrivers\\msedgedriver.exe");
			...
			Thread.sleep(2000);
			  ...
			  System.setProperty("webdriver.chrome.driver", local+"\\mydrivers\\chromedriver.exe");
			  ...
			  System.setProperty("webdriver.gecko.driver", local+"\\mydrivers\\geckodriver.exe");
  ...
  public void shots() throws IOException {
	  String local=System.getProperty("user.dir");
		...
		FileHandler.copy(stored,new File(local+"\\pictures\\"+td+"captured.jpg"));
